...
import { userDetailApi, userStatsApi } from "../services/userManagement.api";
import moment from "moment";
import { useLocation } from "react-router-dom";
import { podcastCardList } from "../utils/data";
import { calculateAge } from "@utils/calculateAge";
import { CashIcon, EventsIcon, UserIcon } from "@utils/svgFile";
...
const useUserProfile = (info, filter) => {
  ...
  const [earningCard, setEarningCard] = useState({
    ...
    count: "$0",
    icon: <CashIcon color="white" opacity="1" height="20px" width="20px" align="left" />,
    width: null
  });
  ...
  }, [getUserDetail, getUserStats, location]);
