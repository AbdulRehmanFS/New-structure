...
export const navbarList = [
  {
    name: "Dashboard",
    icon: <DashboardIcon width={24} height={20} />,
    route: "/dashboard"
  },
  {
  ...
  },
  {
    ...
    icon: <UserIcon width={22} height={18} />,
    route: "/user-management/viewer-creator"
  },
  {
    name: "Content Approval",
    icon: <ContentApprovalIcon width={24} height={20} />,
    route: "/creator/audio-video"
  },
  {
    name: "Live Events and Contents",
    icon: <EventsIcon width={24} height={20} />,
    route: "/events-contents"
  },
  {
    name: "Manage Content",
    icon: <ContentIcon width={24} height={20} />,
    route: "/manage-content/terms-policies"
  },
  {
    name: "Notifications",
    icon: <NotificationIcon width={24} height={20} />,
    route: "/notifications"
  },
  {
    name: "Reports",
    icon: <ReportIcon width={26} height={22} />,
    route: "/reports"
  },
  {
    name: "Earnings",
...
export const modalIcons = {
  delete: <DeleteIcon height={40} width={40} />,
  archive: <ArchiveIcon height={40} width={40} />,
  unarchive: <UnarchiveIcon height={40} width={40} />
};
