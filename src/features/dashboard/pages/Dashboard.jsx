...
export default function Dashboard() {
  ...
  return (
    <>
      ...
      <div className="flex flex-col [&_.left-section]:h-[calc(100vh-133px)] [&_.left-section]:overflow-auto [&_.header-btn-dashboard]:flex [&_.header-btn-dashboard]:justify-between [&_.header-btn-dashboard]:items-center [&_.header-btn-dashboard]:pr-2.5 [&_.main-heading]:text-white [&_.main-heading]:text-lg [&_.light-txt]:text-white [&_.finance-section]:py-5 [&_.finance-section]:mr-2.5 [&_.heading]:text-lg [&_.card-wrapper]:flex [&_.card-wrapper]:flex-col [&_.card-wrapper]:gap-1 [&_.graph-wrapper]:h-[300px] [&_.graph-wrapper]:w-full [&_.podcast-graph-wrapper]:h-[330px] [&_.podcast-graph-wrapper]:pr-5 [&_.podcast-graph-wrapper]:pl-0 [&_.podcast-graph-wrapper]:-ml-5 [&_.podcast-graph-header]:flex [&_.podcast-graph-header]:items-center [&_.podcast-graph-header]:justify-between [&_.podcast-graph-header]:px-5 [&_.podcast-graph-header]:font-semibold [&_.podcast-graph-header]:flex-wrap [&_.podcast-graph-header_.heading]:text-white [&_.podcast-graph-header_.right-section]:flex [&_.podcast-graph-header_.right-section]:gap-8 [&_.podcast-graph-header_.right-section]:items-center" style={{ fontSize: font.mid16, lineHeight: '19.2px' }}>
        <style>{`
        ...
        `}</style>
        <Row>
          <Col xs={17} className="left-section" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
