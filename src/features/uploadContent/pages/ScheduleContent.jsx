...
import { scheduleContentList } from "../utils/scheduleContentData";
...
import { useGetCreatorList, useScheduleContent } from "../hooks";
import { days, frequencyOptions } from "@utils/constant";
import { CalenderIcon } from "@utils/svgFile";
  ...
  return (
    <div className="px-5 py-4">
      <Form onFinish={handleFinish} ref={formRef} form={form}>
        <ModalComponent openModal={openModal} setOpenModal={cancelModal} bg={theme.modalgrey}>
          <div className="p-5 text-[15px] rounded-[10px]">
            <p className="mb-2.5">Repeat</p>
            <div className="flex items-center gap-2.5 text-base mb-2.5">
              <p>Start</p>
              <div className="flex items-center gap-4 pb-1 border-b border-[rgba(255,255,255,0.3)] text-sm">
                <p>{selectedDate} </p>
            ...
            <div className="px-10">
              <div className="py-2.5">
                ...
                {fullName.length > 0 && (
                  <div className="py-2.5">
                    <div className="flex flex-wrap text-sm text-[rgba(255,255,255,0.7)]">
                      {fullName.map((e, i) => (
                        <span key={i}>
                          {i == 0 && "Occur every "} {e}
