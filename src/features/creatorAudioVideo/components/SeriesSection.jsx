...
import { useSeriesListing } from "../hooks";

const SeriesSection = ({ searchText = "" }) => {
  const {
  ...
  return (
    <div className="mt-5">
      <div className="flex flex-col sm:flex-row flex-wrap justify-between items-start sm:items-center gap-3 rounded-xl bg-[rgba(10,10,10,0.85)] px-3 sm:px-5 py-4 mb-5">
        <div className="text-xl sm:text-2xl font-semibold text-white">Series Listing</div>
...
export default memo(SeriesSection);
